  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 10, pointerEvents: 'none' }}>
      ...
      >
        ...
        {/* Left bottom — role + copy + social */}
        <div
          style={{
            position: 'absolute',
            bottom: 'clamp(8px, 8vh, 48px)', // Lower position
          ...
          >
            ...
            <p
              style={{
                ...
                margin: '0 0 8px', // tighter gap
              }}
            >
              Turning complexity into clarity through<br />
              intentional design and obsessive craft.
            </p>
            <div style={{ display: 'flex', gap: 22, alignItems: 'center' }}>
              {/* X / Twitter */}
              <a
                href="https://x.com/_anurag_adarsh"
                target="_blank" rel="noopener noreferrer"
                className="hero-social"
                style={{ display: 'flex', alignItems: 'center', gap: 7, color: 'rgba(255,255,255,0.28)', textDecoration: 'none' }}
              >
      ...
      >
        ...
        >
          ...
          <svg
            ...
            style={{ animation: 'scroll-spin 10s linear infinite' }}
          >
            <defs>
              <path
                id="scrollCircle"
